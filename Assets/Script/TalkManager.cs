...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        //퀘스트없는 npc
        talkData.Add(18000, new string[] { "안녕~","날이좋지?" });
        talkData.Add(19000, new string[] { "길을 잃었다~" });
        talkData.Add(20000, new string[] { "안녕~ 반가워" });
        talkData.Add(21000, new string[] { "수업 늦겠다..." });
        talkData.Add(22000, new string[] { "안녕~" });
        talkData.Add(23000, new string[] { "종강마렵다.." });
        talkData.Add(24000, new string[] { "운동장이 참 크지?~" });
        talkData.Add(25000, new string[] { "물이 맑다.." });
        
        

        //Quest Talk
        talkData.Add(10 + 1000, new string[] { "환영해! 여기는 하양에 위치한 대구가톨릭대학교라고해.", "여기는 가톨릭학교이니만큼 학교 안에 성당이 있어.", "그런의미에서 우리 학교 중심에 있는 성모상을 먼저 보고 오도록 해!" });
