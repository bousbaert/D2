...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(90 + 16000, new string[] { "여기는 1,2인실이 존재하는 참인재관이야","1층에는 편의시설인 작은마트와 작은카페가 있어.","학교 밖까지 나가기 귀찮다면 여기가 좋아" });
        talkData.Add(91 + 16000, new string[] { "이제 학교는 대충 다 둘러봤지?","이제부턴 혼자 돌아다녀봐~" });
